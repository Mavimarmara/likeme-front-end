  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        />
        <Stack.Screen name='Home' component={HomeScreen} options={{ title: 'Home', animationEnabled: false }} />
        ...
        <Stack.Screen name='MarkerDetails' component={MarkerDetailsScreen} options={{ title: 'Detalhes do Marker' }} />
      </Stack.Navigator>
    </NavigationContainer>
  );
};
